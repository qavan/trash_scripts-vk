...
while api.groups.getMembers(group_id=group,sort='id_asc',fields='',offset=off)['users']!=[]:
	time.sleep(1)
	m=api.groups.getMembers(group_id=group,sort='id_asc',fields='',offset=off)['users']
	off+=1000
	time.sleep(1)
